...
public class MineMessageFragmentModule {
    public void getMineHelpData(String userId, String status,final OnGetMineHelpFinishListener listener){
        HttpUtils.getMineHelpOrQuestions("/mySeekHelp", userId, status, new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                ...
                switch (code.getCode()) {
                    case 200:
                        listener.returnMineHelp(code.getData());
                        break;
                    case 0:
