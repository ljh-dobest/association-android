...
import com.min.helpcenter.ui.fragments.AnswerMessageFragment;
import com.min.helpcenter.ui.fragments.MineMessageFragment;
...
//    TabLayout tl_mineMessage;
    ...
    private void initView() {
        ...
        mineMessageFragment.setUserId(userId);
        AnswerMessageFragment answerMessageFragment=new AnswerMessageFragment();
        answerMessageFragment.setUserId(userId);
        fragments.add(mineMessageFragment);
        fragments.add(answerMessageFragment);
        titles.add("我的求助");
        titles.add("我的回答");
