...
public class AppContext extends RongIMClient.ResultCallback<Boolean> implements RongIMClient.ConnectionStatusListener,
...
//自定义群组聊天加号输入框
    public static void setGroupInputProvider() {
        ...
        if (moduleList != null) {
            ...
            if (defaultModule != null) {
                ...
                RongExtensionManager.getInstance().registerExtensionModule(new GroupTalkExtensionModule());
            }
        }
    }
    //自定义个人聊天加号输入框
    public static void setPersonInputProvider() {
        List<IExtensionModule> moduleList = RongExtensionManager.getInstance().getExtensionModules();
        IExtensionModule defaultModule = null;
        if (moduleList != null) {
            for (IExtensionModule module : moduleList) {
...
//                L.e("---------------AppContent","111111111111111111");
    ...
    public boolean onReceived(Message message, int i) {
        ...
        if (messageContent instanceof ContactNotificationMessage) {
            EventBus.getDefault().postSticky(new FriendInfo());
            ContactNotificationMessage contactNotificationMessage = (ContactNotificationMessage) messageContent;
...
//                // 发广播通知更新好友列表
    ...
    public void onError(RongIMClient.ErrorCode errorCode) {
        Log.e("delete",errorCode.toString());
    }
}
