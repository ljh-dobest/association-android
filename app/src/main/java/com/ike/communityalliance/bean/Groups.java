...
public class Groups implements Parcelable{
    ...
    public Groups(String groupId, String groupName, String groupPortraitUrl) {
        this.groupId = groupId;
        this.groupName = groupName;
        this.groupPortraitUrl = groupPortraitUrl;
    }
    public Groups(String groupId, String groupName, String groupPortraitUrl,String role) {
        this.groupId = groupId;
        this.groupName = groupName;
        this.groupPortraitUrl = groupPortraitUrl;
        this.role=role;
    ...
    public Groups(String userId, String groupId, String groupName, String groupPortraitUrl,
    ...
    public Groups(Parcel in) {
        ...
        groupPortraitUrl = in.readString();
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(groupPortraitUrl);
