package com.ike.communityalliance.message;
...
/**
 * Created by Min on 2017/3/24.
 */
@MessageTag(value = "app:custom", flag = MessageTag.ISCOUNTED | MessageTag.NONE)
public class TalkTalkMessage  extends MessageContent {
    ...
    public TalkTalkMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public TalkTalkMessage(Parcel in) {
     ...
     */
    public TalkTalkMessage(String content) {
