...
import com.ike.communityalliance.ui.activity.IatSettings;
import com.ike.communityalliance.wedget.audio.AudioRecordFunc;
import com.ike.communityalliance.wedget.audio.FucUtil;
...
public class MyStartRecognizePlugin implements IPluginModule {
    ...
    public Drawable obtainDrawable(Context context) {
        L.e("------------","obtainDrawable");
        return ContextCompat.getDrawable(context, R.mipmap. voice);
    }
