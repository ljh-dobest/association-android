...
public class PossibleUnderstandPeopleRvAdapter extends RecyclerView.Adapter<PossibleUnderstandPeopleRvAdapter.MyViewHolder> {
    ...
    public PossibleUnderstandPeopleRvAdapter(Context context, String useId,String nickName) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Picasso.with(mContext).load(HttpUtils.IMAGE_RUL+possiblePeopleBean.getUserPortraitUrl()).into(holder.ivPossibleUnderstandItemHeader);
        holder.ivPossibleUnderstandItemSex.setImageResource(possiblePeopleBean.getSex().equals("1")?R.drawable.mine_man:R.drawable.mine_women);
        holder.tvPossibleUnderstandItemName.setText(possiblePeopleBean.getNickname());
        holder.tvPossibleUnderstandItemNumber.setText(possiblePeopleBean.getNumberId());
        holder.tvPossibleUnderstandItemSameNumber.setText(possiblePeopleBean.getCount()+"位共同好友");
        if(possiblePeopleBean.getRelationship()==null){
            holder.tvPossibleUnderstandItemRelation.setVisibility(View.GONE);
        }else{
            holder.tvPossibleUnderstandItemRelation.setText(getRelationship(possiblePeopleBean.getRelationship()));
        }
