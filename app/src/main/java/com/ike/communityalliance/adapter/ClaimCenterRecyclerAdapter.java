...
import com.ike.communityalliance.wedget.OvalImageView;
...
public class ClaimCenterRecyclerAdapter extends RecyclerView.Adapter<ClaimCenterRecyclerAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if(imgUrl==null){
            holder.iv_claim_lv_item.setImageResource(R.drawable.ic_launcher);
        }else{
            Picasso.with(mContext).load(HttpUtils.IMAGE_RUL+bean.getUserPortraitUrl()).into(holder.iv_claim_lv_item);
        }
        holder.tv_claim_lv_item.setText(bean.getNickname());
