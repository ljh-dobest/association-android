...
public class FriendListAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(TextUtils.isEmpty(list.get(position).getDisplayName())||list.get(position).getDisplayName().equals("null")){
        ...
        String url=list.get(position).getUserPortraitUrl();
        if (TextUtils.isEmpty(url)) {
            String s = Generate.generateDefaultAvatar(list.get(position).getNickname(), list.get(position).getUserId());
