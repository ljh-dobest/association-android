...
public class MyPhoneActivity_ViewBinding<T extends MyPhoneActivity> implements Unbinder {
  ...
  @UiThread
  public MyPhoneActivity_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    target.etAddPhone = Utils.findRequiredViewAsType(source, R.id.et_add_phone, "field 'etAddPhone'", EditText.class);
  }
