...
public class HomePageLVAdapter$ViewHolder_ViewBinding<T extends HomePageLVAdapter.ViewHolder> implements Unbinder {
  ...
  public HomePageLVAdapter$ViewHolder_ViewBinding(T target, View source) {
    ...
    target.tv_home_item_recommenderId = Utils.findRequiredViewAsType(source, R.id.tv_home_item_recommenderId, "field 'tv_home_item_recommenderId'", TextView.class);
    target.tv_home_item_recommenderName = Utils.findRequiredViewAsType(source, R.id.tv_home_item_recommenderName, "field 'tv_home_item_recommenderName'", TextView.class);
    target.tv_home_item_toClaim = Utils.findRequiredViewAsType(source, R.id.tv_home_item_toClaim, "field 'tv_home_item_toClaim'", TextView.class);
  }
  ...
  public void unbind() {
    ...
    target.tv_home_item_recommenderId = null;
    target.tv_home_item_recommenderName = null;
    target.tv_home_item_toClaim = null;
