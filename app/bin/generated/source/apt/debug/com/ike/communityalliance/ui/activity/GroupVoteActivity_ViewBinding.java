...
public class GroupVoteActivity_ViewBinding<T extends GroupVoteActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public GroupVoteActivity_ViewBinding(final T target, View source) {
    this.target = target;
    ...
    target.rvGroupVote = Utils.findRequiredViewAsType(source, R.id.rv_group_vote, "field 'rvGroupVote'", RecyclerView.class);
