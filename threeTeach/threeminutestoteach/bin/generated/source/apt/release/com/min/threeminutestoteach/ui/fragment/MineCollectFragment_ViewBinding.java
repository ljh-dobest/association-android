...
public class MineCollectFragment_ViewBinding<T extends MineCollectFragment> implements Unbinder {
  protected T target;

  @UiThread
  public MineCollectFragment_ViewBinding(T target, View source) {
    this.target = target;
