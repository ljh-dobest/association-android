package com.min.threeminutestoteach.views;
    ...
    protected void updateStartImage() {
        ...
        if (mIfCurrentIsFullscreen) {
            ...
            if (mCurrentState == CURRENT_STATE_PLAYING) {
                imageView.setImageResource(R.mipmap.vedio_stop);
            } else if (mCurrentState == CURRENT_STATE_ERROR) {
                imageView.setImageResource(R.mipmap.vedio_start);
            } else {
                imageView.setImageResource(R.mipmap.vedio_start);
            }
        } else {
           // super.updateStartImage();
            ...
            if (mCurrentState == CURRENT_STATE_PLAYING) {
                enPlayView.setImageResource(R.mipmap.vedio_stop);
            } else if (mCurrentState == CURRENT_STATE_ERROR) {
                enPlayView.setImageResource(R.mipmap.vedio_start);
            } else {
                enPlayView.setImageResource(R.mipmap.vedio_start);
            }
        }
