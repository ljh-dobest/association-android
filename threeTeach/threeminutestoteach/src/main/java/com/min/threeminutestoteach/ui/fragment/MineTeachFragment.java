...
public class MineTeachFragment extends Fragment implements MineTeacheRVAdapter.OnItemClickLitener {
...
public void setUserId(String userId){
    ...
    private void getMineTeachData() {
        HttpUtils.getMineThreeTeachData("/selectMyVideo", userId, new StringCallback() {
            @Override
